...
export const ABOUT_DATA = {
    ...
    heroIntro: {
        ...
        ja: '大阪大学大学院基礎工学研究科博士後期課程、XR Group に所属。コンピュータビジョン、グラフィクス、インタラクションを介して人を研究しています。',
    } satisfies BL,
    bio: {
        en: 'I study human subjective experience as an interplay between perception, interpretation, thought, and expression. My work develops computational media that measure, modulate, and re-present this interplay through computer vision, computer graphics, and human-computer interaction. I implement these ideas as novel capture/display systems and experimental experiences. Beyond technical functionality, I view humans and creative artifacts as socially and culturally situated entities whose meanings evolve through use, interpretation, and communication. Through this perspective, I explore how technology can expand the possibilities of expression, interpretation, and communication.',
        ja: '人の主観体験を「知覚・解釈・思考・表現が相互に影響し合うプロセス」として捉え、そのプロセスを計測・変調・再提示する計算メディアを研究しています。コンピュータビジョン、グラフィクス、インタラクションを横断し、新しいキャプチャ／ディスプレイシステムや実験的体験として実装することを目指しています。また、人間やその創作物を社会や文化の中で意味を変えながら生きる存在として捉え、技術が表現・解釈・コミュニケーションのあり方をどのように拡張しうるかにも関心があります。',
    } satisfies BL,
    interests: {
